...
class Window(QMainWindow):
    def __init__(self):
        ...
        self.setWindowTitle(' FinanceTrack')
    ...
    def toolBar(self):
        ...
        self.tb.setStyleSheet("font: 11pt Arial; color: black; background-color: white; border: none")
        self.tb.setToolButtonStyle(Qt.ToolButtonTextUnderIcon)
        self.logo=QLabel()
        logopixmap=QPixmap("icons/logo.png")
        self.logo.setPixmap(logopixmap)
        self.tb.addWidget(self.logo)
        self.toolbarBanner=QLabel("     Finance Tracker                                     ")
    ...
    def widgets(self):
        ...
        self.hometitle.setStyleSheet("color:white;background-color:#A7C7E7")
        self.hometitle.setFont(QFont("Arial", 20))
        self.homeImg = QLabel()
        homepixmap = QPixmap('icons/home.png')
        self.homeImg.setPixmap(homepixmap)
        self.homeImg.setStyleSheet("background-color:#A7C7E7")
        self.homeSpending = QLabel(f"{self.homespending} $")
        self.homeSpending.setFont(QFont("Arial", 20))
        self.homeSpending.setStyleSheet("background-color:#A7C7E7; color: white;")

        self.transporttitle=QLabel("Transport                   ")
        self.transporttitle.setStyleSheet("color:white;background-color:#A7C7E7;qproperty-alignment: AlignLeft")
        self.transporttitle.setFont(QFont("Arial", 20))
        self.busImg = QLabel()
        buspixmap = QPixmap('icons/bus.png')
        self.busImg.setPixmap(buspixmap)
        self.busImg.setStyleSheet("background-color:#A7C7E7;")
        self.busSpending = QLabel(f"{self.busspending} $")
        self.busSpending.setFont(QFont("Arial", 20))
        self.busSpending.setStyleSheet("background-color:#A7C7E7; color: white;")

        self.clothestitle=QLabel("Clothes                  ")
        self.clothestitle.setStyleSheet("color:white;background-color:#A7C7E7")
        ...
        self.clothesImg.setStyleSheet("background-color:#A7C7E7")
        self.clothesSpending = QLabel(f"{self.clothesspending} $")
        self.clothesSpending.setFont(QFont("Arial", 20))
        self.clothesSpending.setStyleSheet("background-color:#A7C7E7; color: white;")

        self.eattitle=QLabel("Food                    ")
        self.eattitle.setStyleSheet("color:white;background-color:#A7C7E7")
        self.eattitle.setFont(QFont("Arial", 20))
        self.eatImg = QLabel()
        eatpixmap = QPixmap('icons/eat.png')
        self.eatImg.setPixmap(eatpixmap)
        self.eatImg.setStyleSheet("background-color:#A7C7E7")
        self.eatSpending = QLabel(f"{self.eatspending} $")
        self.eatSpending.setFont(QFont("Arial", 20))
        self.eatSpending.setStyleSheet("background-color:#A7C7E7; color: white;")
        
        self.phonetitle=QLabel("Phone                ")
        self.phonetitle.setStyleSheet("color:white;background-color:#A7C7E7")
        ...
        self.phoneImg.setStyleSheet("background-color:#A7C7E7")
        self.phoneSpending = QLabel(f"{self.phonespending} $")
        self.phoneSpending.setFont(QFont("Arial", 20))
        self.phoneSpending.setStyleSheet("background-color:#A7C7E7; color: white;")

        self.credittitle=QLabel("Credit Card                ")
        self.credittitle.setStyleSheet("color:white;background-color:#A7C7E7")
        self.credittitle.setFont(QFont("Arial", 20))
        self.carImg = QLabel()
        carpixmap = QPixmap('icons/creditcard.png')
        self.carImg.setPixmap(carpixmap)
        self.carImg.setStyleSheet("background-color:#A7C7E7")
        self.creditSpending = QLabel(f"{self.creditspending} $")
        self.creditSpending.setFont(QFont("Arial", 20))
        self.creditSpending.setStyleSheet("background-color:#A7C7E7; color: white;")

        self.investmenttitle=QLabel("Others                ")
        self.investmenttitle.setStyleSheet("color:white;background-color:#A7C7E7")
        ...
        self.othersImg.setStyleSheet("background-color:#A7C7E7")
        self.othersSpending = QLabel(f"{self.others} $") 
        self.othersSpending.setFont(QFont("Arial", 20))
        self.othersSpending.setStyleSheet("background-color:#A7C7E7; color: white;")
        #right
        ...
        self.Salary = QLabel(f"Income: {round(self.salary, 2)} $")
        ...
        self.Spend = QLabel(f"Investment: {round(self.investment, 2)} $")
        ...
        self.Investment = QLabel(f"Investment: {round(self.investment, 2)} $")
        ...
        self.Balance = QLabel(f"Balance: {round(self.salary - self.spend - self.investment, 2)} $")
    ...
    def funcBalanceFigure(self):
        if self.spend != 0.0:
            ...
            parts = ["Household", 'Transport', 'Clothes','Food','Phone','Credit Card','Others'] 
    ...
    def getValues(self):
        ...
        self.Salary.setText(f"Income: {round(self.salary, 2)} $")
        ...
        self.Spend.setText(f"Spendings: {round(self.spend, 2)} $")

        self.Balance.setText(f"Balance: {round(self.salary - self.spend, 2)} $")
        ...
        self.Investment.setText(f"Investment: {round(self.investment, 2)} $")
        ...
        self.homeSpending.setText(f"{round(self.homespending, 2)} $")
        ...
        self.busSpending.setText(f"{round(self.busspending, 2)} $")
        ...
        self.clothesSpending.setText(f"{round(self.clothesspending, 2)} $")
        ...
        self.eatSpending.setText(f"{round(self.eatspending, 2)} $")
        ...
        self.phoneSpending.setText(f"{round(self.phonespending, 2)} $")
        ...
        self.creditSpending.setText(f"{round(self.creditspending, 2)} $")
        ...
        self.othersSpending.setText(f"{round(self.others, 2)} $")
